...
export type StartRuleNames = "JsonpathQuery";
export interface ParseOptions<T extends StartRuleNames = "JsonpathQuery"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"JsonpathQuery">>(
  input: string,
  options?: Options,
): import('./ast.d.ts').JsonpathQuery;
