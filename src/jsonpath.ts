...
const peggyParser: { parse: any; SyntaxError: any; DefaultTracer?: any } = // Generated by Peggy 3.0.2.
  ...
  (() => {
    ...
    function peg$parse(input, options) {
      ...
      var peg$f2 = (literals) => literals.join(""); // @ts-ignore

      var peg$f3 = (literals) => literals.join(""); // @ts-ignore

      var peg$f4 = () => "\b"; // @ts-ignore

      var peg$f5 = () => "\f"; // @ts-ignore

      var peg$f6 = () => "\n"; // @ts-ignore

      var peg$f7 = () => "\r"; // @ts-ignore

      var peg$f8 = () => "\t"; // @ts-ignore

      var peg$f9 = () => "/"; // @ts-ignore

      var peg$f10 = () => "\\"; // @ts-ignore

      var peg$f11 = (chars) => String.fromCharCode(...chars); // @ts-ignore

      var peg$f12 = (code) => [code]; // @ts-ignore

      var peg$f13 = (pair) => pair; // @ts-ignore

      var peg$f14 = () => Number.parseInt(text(), 16); // @ts-ignore

      var peg$f15 = () => Number.parseInt(text(), 16); // @ts-ignore

      var peg$f16 = () => Number.parseInt(text(), 16); // @ts-ignore

      var peg$f17 = () => Number.parseInt(text(), 16); // @ts-ignore

      var peg$f18 = () => ({ type: "WildcardSelector" }); // @ts-ignore

      var peg$f19 = (index) => ({ type: "IndexSelector", index: index }); // @ts-ignore

      var peg$f20 = () => 0; // @ts-ignore
      ...
      var peg$f23 = (expr) => ({ type: "FilterSelector", expr: expr }); // @ts-ignore

      var peg$f24 = (head, tail) => {
        // @ts-ignore
        return buildLogicalExpression(head, tail);
      }; // @ts-ignore

      var peg$f25 = (head, tail) => {
        // @ts-ignore
        return buildLogicalExpression(head, tail);
      }; // @ts-ignore

      var peg$f26 = (not, expr) => {
        // @ts-ignore
        if (not) {
          // @ts-ignore
          return {
      ...
      var peg$f34 = (selector) => [selector]; // @ts-ignore

      var peg$f35 = (selector) => [selector]; // @ts-ignore

      var peg$f36 = (selector) => [selector]; // @ts-ignore

      var peg$f37 = (int, frac, exp) => {
        // @ts-ignore
        return Number.parseFloat(`${int}${frac ?? ""}${exp ? `e${exp}` : ""}`);
      }; // @ts-ignore

      var peg$f38 = (sign, digits) => {
        // @ts-ignore
        return Number.parseInt(`${sign || ""}${digits.join("")}`);
      }; // @ts-ignore
      ...
      var peg$f43 = (selector) => [selector]; // @ts-ignore

      var peg$f44 = (head, tail) => {
        // @ts-ignore
...
export type ParseFunction = <Options extends ParseOptions>(
  ...
  ? StartRule extends "JsonpathQuery"
    ? JsonpathQuery
    : JsonpathQuery
  : JsonpathQuery;
